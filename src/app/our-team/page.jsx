      ...
      <div className="w-full h-[60vh] relative">
        <div className="before:content-[''] w-full h-[60vh] relative before:absolute before:bg-[#0000009f] before:z-20 before:top-0 before:right-0 before:left-0 before:bottom-0">
          <Image
            ...
            fill={true}
            src="https://i.ibb.co/s2pn0Bg/marvin-meyer-SYTO3xs06f-U-unsplash-min.jpg"
            alt=""
          />
        </div>
        ...
        <div className="absolute z-30 max-w-[1240px] w-full mx-auto top-5 left-0 right-0  text-white h-full flex justify-center flex-col">
          <h2 className="text-6xl text-center text-[white] pb-5 font-bold">
            Devsmanbd Team
          </h2>
        </div>
      </div>
            ...
            <div className="avatar pt-[35px] flex justify-center items-center">
              <div className="w-[160px] relative  h-[160px]  rounded-full">
                <Image
                  ...
                  className="duration-500 transform rounded-full hover:scale-105"
                  src="https://i.ibb.co/YNX8jYx/Whats-App-Image-2023-07-22-at-12-20-30-AM.jpg"
                />
              </div>
            </div>
              ...
              <div>
                <div className="flex justify-center gap-3 mt-16 text-3xl">
                  <a target="_blank" href="https://twitter.com/developerSagor">
                    <div
                      target="_blank"
                      className="p-[7px] bg-[#A1A1A1] hover:bg-[#2BA1E9] duration-500 rounded-full"
                    >
                      <RiTwitterFill
                        target="_blank"
            ...
            <div className="avatar pt-[35px] flex justify-center items-center">
              <div className="w-[160px] relative h-[160px]  rounded-full">
                <Image
                  ...
                  alt="team member image"
                  className="duration-500 transform rounded-full hover:scale-105"
                  src="https://i.ibb.co/Ybmd3cb/361614513-923929135369407-8705623956156444758-n.png"
                />
              </div>
            </div>
              ...
              <div>
                <div className="flex justify-center gap-3 mt-16 text-3xl">
                  ...
                  <a href="https://www.linkedin.com/in/tofael005/">
                    <div
                      fill={true}
                      className="p-[7px] bg-[#A1A1A1] hover:bg-[#0A66C2] duration-500 rounded-full"
                    >
                      <FaLinkedinIn className="text-white "></FaLinkedinIn>
                    </div>
                  </a>
