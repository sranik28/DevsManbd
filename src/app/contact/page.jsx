                        ...
                        <div className="">
                            <form  >
                                ...
                                <FormControl className='mb-5' isRequired>
                                    ...
                                    <Input className='w-full p-4 my-3 duration-300 transform bg-transparent border rounded-md shadow-sm outline-none focus:scale-105 shadow-black/50 border-white/10 placeholder:font-normal' type="email" name='user_email' placeholder='Enter your name' />

                                </FormControl>

                                <FormControl className='mb-5' isRequired>
                                    <FormLabel className='font-semibold'>MOBILE NUMBER</FormLabel>
                                    <Input className="w-full p-4 my-3 mb-5 duration-300 transform bg-transparent border rounded-md shadow-sm outline-none placeholder:font-normal focus:scale-105 border-white/10 shadow-black/50" type="text" name='mobile_number' placeholder='Enter your question' />
                                </FormControl>
